...
# Case 1
setenv prefix_1   b.e11.B20TRBDRD.f09_g16.iESM_ctrl.001_1850-2004	# used for output file names
setenv caseid_1   b.e11.B20TRBDRD.f09_g16.iESM_ctrl.001  	  	# identifies history files
...
if ($OBS == 1) then
   ...
   setenv prefix_2 b.e11.B20TRBDRC.f09_g16.iESM_ctrl.001_1850-2004 	# USER SUPPLIED for output file names
   setenv caseid_2 b.e11.B20TRBDRC.f09_g16.iESM_ctrl.001 	 	# identifies history files
