...
if ($regrid_1 == 1) then
  ...
  foreach file ($files)
    ...
    ncks -A -v area ${area_dir}/${area_file} {$prefix_1_dir}/$OutFile
...
if ($regrid_2 == 1) then
  ...
  foreach file ($files)
    ...
    ncks -A -v area ${area_dir}/${area_file} {$prefix_2_dir}/$OutFile
