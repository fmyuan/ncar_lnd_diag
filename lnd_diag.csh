...
# Nersc machine
 setenv PTMPDIR         /project/projectdirs/m1204/shix/ACME_E/lnd_diag/results
 setenv SOURCE_1       /project/projectdirs/m1204/shix/ACME_E/model_outputs
 setenv SOURCE_2       /project/projectdirs/m1204/shix/ACME_E/model_outputs
...
setenv DIAG_HOME /project/projectdirs/m1204/shix/ACME_E/lnd_diag/lnd_diag4.2.28		# CISL

#*****************************************************************
# 2b:  Path to observational datasets
#*****************************************************************
# setenv OBS_HOME  /project/tss/diag/lnd_diag4.2		# CGD
setenv OBS_HOME  /project/projectdirs/m1204/shix/ACME_E/lnd_diag/lnd_diag4.2.28 		# CISL
...
#**************************************************
setenv OBS		0	# model vs observations (1 = ON; 0 = OFF)
setenv ModelVsModel	1	# model1 vs model2      (1 = ON; 0 = OFF)
...
# Case 1
setenv prefix_1   b.e11.B20TRBDRD.f09_g16.iESM_ctrl.002_1850-2004	# used for output file names
setenv caseid_1   b.e11.B20TRBDRD.f09_g16.iESM_ctrl.002  	  	# identifies history files
...
if ($OBS == 1) then
   ...
   setenv prefix_2 b.e11.B20TRBCRD.f09_g16.iESM_ctrl.002_1850-2004   	# USER SUPPLIED for output file names
   setenv caseid_2 b.e11.B20TRBCRD.f09_g16.iESM_ctrl.002 	 	# identifies history files
...
#**************************************************
setenv clim_first_yr_1          1850      # YYYY (must be >= 1)
setenv clim_num_yrs_1             155      # number of yrs (must be >= 1)
if ($ModelVsModel == 1) then
  setenv clim_first_yr_2        1850     # YYYY (must be >= 1)
  setenv clim_num_yrs_2           155     # number of yrs (must be >= 1)
endif

#**************************************************
# 9:  Specify first year and number of years to be analyzed for long-term trends (TRENDS).
#**************************************************
setenv trends_first_yr_1        1850      # YYYY (must be >= 1)
setenv trends_num_yrs_1           155      # number of yrs (must be >= 2)
if ($ModelVsModel == 1) then
  setenv trends_first_yr_2      1850     # YYYY (must be >= 1)
  setenv trends_num_yrs_2         155     # number of yrs (must be >= 2)
endif
...
setenv setRestart_set   9   # (Valid sets:  2,3,4,5,6,7,8,9)
#**************************************************
# 16:  User preferences:
...
#**************************************************
 ...
 setenv density        144      # controls density of output .gif images, example values = 72,96,144,216,288 (higher values = higher quality)
...
if ($web_pages == 1) then
 ...
 setenv delete_webdir    1      # (1=ON,0=OFF)  delete webdir with GIF files                         (default = 1)
...
#**************************************************
setenv remote      1      # (1=ON,0=OFF)  send email to unix.
...
setenv wgt_dir_2  /glade/p/cesm/lmwg/diag/lnd_diag4.2/regriddingFiles/ne120/
