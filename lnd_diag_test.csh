...
# Nersc machine
 setenv PTMPDIR        ${CURRDIR}/lnd_diag/results
 setenv SOURCE_1       ${CURRDIR}/lnd_diag/testncl/demo1
 setenv SOURCE_2       ${CURRDIR}/lnd_diag/testncl/demo2
...
setenv LOCAL_FLAG_2       1	#1=ON; 0=OFF
...
#**************************************************
setenv DIAG_HOME /Users/f9y/lnd_diag4.2.28

#*****************************************************************
# 2b:  Path to observational datasets
#*****************************************************************
setenv OBS_HOME  /Users/f9y/lnd_diag4.2.28
...
# Case 1
setenv prefix_1   demo1	# used for output file names
setenv caseid_1   tr_testncl  	  	# identifies history files
setenv commonName_1    demo1  	# (Optional) common name for ID'ing run e.g., low water use
...
if ($OBS == 1) then
   ...
   setenv caseid_2 tr_testncl2 	 	# identifies history files
...
#**************************************************
setenv LOCAL_1       /Users/f9y/Desktop/ELM_global_N60/RUN4/Archives/${caseid_1}/lnd/hist
setenv LOCAL_2       /Users/f9y/project_acme/archives/${caseid_2}/lnd/hist
...
#**************************************************
setenv clim_first_yr_1          2000      # YYYY (must be >= 1)
setenv clim_num_yrs_1            2      # number of yrs (must be >= 1)
...
#**************************************************
setenv trends_first_yr_1        2000      # YYYY (must be >= 1)
setenv trends_num_yrs_1           2      # number of yrs (must be >= 2)
if ($ModelVsModel == 1) then
...
#**************************************************
 ...
 setenv deleteProcDir    0      # (1=ON,0=OFF)  delete processing directory.  Turn off if you are
...
setenv swift_scratch_dir ${HOME}/project_acme/sratch/swift_scratch
setenv RUNDIR /$HOME/project_acme/scratch/lnd_diag/run/
